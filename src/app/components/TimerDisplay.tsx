    ...
    <>
      ...
      <div className="flex items-center justify-center gap-2 mb-3">
        <span className="relative flex h-3 w-3">
          ...
          <span className="relative inline-flex rounded-full h-3 w-3 bg-themed"></span>
        </span>
        <span className="text-sm text-themed-light font-medium">
      ...
      <div className="flex items-center justify-center gap-1.5 sm:gap-2 my-5">
        <div className="glass-light rounded-xl px-3 py-2.5 min-w-[60px] sm:min-w-[68px]">
          <div className="text-2xl sm:text-3xl font-mono font-bold text-themed-light timer-digit">
