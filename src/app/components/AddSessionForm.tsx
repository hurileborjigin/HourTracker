    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            required
            className="w-full px-3 py-2.5 bg-black/20 border border-themed/30 rounded-xl focus:ring-2 focus:ring-current focus:border-current outline-none text-white transition-all"
          />
        </div>
        <div>
      ...
      <div className="flex gap-2">
        <button
          type="submit"
          disabled={loading}
          className="flex-1 btn-themed text-white py-3 rounded-xl font-semibold  disabled:opacity-50 transition-all duration-300 shadow-lg shadow-themed"
        >
          Save Session
        </button>
        <button
